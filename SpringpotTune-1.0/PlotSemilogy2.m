...
% ----------------------------------------------------------------- 
function fig = PlotSemilogy2(time1,data1,time2,data2,graphobj)
    ...
    semilogy(time1, data1, 'LineWidth', 2, ...
    ...
    semilogx(time2, data2, 'LineWidth', 2, ...
    ...
    % Labels and title
    xlabel(graphobj.xlab, 'FontSize', 18, 'FontWeight', 'bold');
    ylabel(graphobj.ylab, 'FontSize', 18, 'FontWeight', 'bold');
